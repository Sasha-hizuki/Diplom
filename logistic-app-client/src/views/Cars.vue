...
export default {
    data(){
        return {
            ...
            loading: true,
            Form:false,
            item:{id:null,brand:null,model:null,number:null,mileage:null,fuel_consumption:null,toDate:null,blrInsuranceDate:null,gcInsuranceDate:null},
            search:""
        }
    },
    computed:{
    ...
    methods:{
        ...
        newItem(){
            this.item = {id:null,brand:null,model:null,number:null,mileage:null,fuel_consumption:null,toDate:null,blrInsuranceDate:null,gcInsuranceDate:null};
            this.openModal()
        },
        openModal(){
            this.Form = true;
